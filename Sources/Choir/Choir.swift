/// CHOIR: A fully on-device neural voice synthesis engine for the Apple ecosystem.
///
/// This package provides complete text-to-speech synthesis with 32 original synthetic voices,
